          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-water-gradient text-primary-foreground font-semibold hover:opacity-90 transition-opacity"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-card border-2 border-primary text-primary font-semibold hover:bg-primary/5 transition-colors"
              >
